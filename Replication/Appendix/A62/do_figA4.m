%% FIGURES A.4, A.5, A.6, A.7. TABLE A.5. COMPARE RULES IN THE 3 EQUATION 
%% NEW-KEYNESIAN MODEL UNDER A COST PUSH SHOCK
% Parametrization is the standard Eggertsson and Woodford (2003). Shocks
% are set to generate a drop in output on impact of 7.5%, and no drop in
% inflation under a Truncated Taylor Rule (TTR).
...
cfg.path = 'Replication/Appendix/A72';
