...
% Truncated Taylor rule (contemporaneous inflation and output, smoothed)
...
BBB(eq.rule,vars.pi)       = (1-param.phi_i)*param.phi_pi;
BBB(eq.rule,vars.x)        = (1-param.phi_i)*param.phi_x;
