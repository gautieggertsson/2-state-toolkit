...
BBB(eq.policy,vars.y)      =  (1-param.sho_r)*param.psi_y;
BBB(eq.policy,vars.yp4)    = -(1-param.sho_r)*param.psi_y;
BBB(eq.policy,vars.Rpast)  = param.sho_r;
BBB(eq.policy,vars.pi)     = (1-param.sho_r)*param.psi_pi;
BBB(eq.policy,vars.pip1)   = (1-param.sho_r)*param.psi_pi;
BBB(eq.policy,vars.pip2)   = (1-param.sho_r)*param.psi_pi;
BBB(eq.policy,vars.pip3)   = (1-param.sho_r)*param.psi_pi;
