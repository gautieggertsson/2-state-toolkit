...
AAA(eq.ngdpc,vars.ny_lag) = 1;
AAA(eq.ngdpc,vars.p_lag)  = -1;
AAA(eq.ngdpc,vars.pstar)  = 1;
BBB(eq.ngdpc,vars.y)      = 1;
BBB(eq.ngdpc,vars.ny_lag) = 1;

% Truncated Taylor rule (contemporaneous inflation and output)
BBB(eq.rule,vars.R)        = -1;
AAA(eq.rule,vars.ny_lag)   = -param.psi_yc;
