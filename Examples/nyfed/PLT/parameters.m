...
param.lagr_pi        = 1;
param.lagr_x         = 1/16;
param.lagr_rule      = param.lagr_x;
param.kappa_rule     = (1-param.zeta_p)*(1-param.zeta_p*param.beta)/(param.zeta_p);
param.mu             = 0.73626;
...
param.sl = [param.sl;param.spsl;log(param.pistar);param.ul];
param.sh = [0;0;log(param.pistar);0];
