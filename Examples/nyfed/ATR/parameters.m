...
param.alpha_ATR           = 0.8;   % alpha parameter in ATR rule
...
param.rl = [param.rl;param.spsl;param.ul]; %[-0.097;3] double i to c;[-0.100;2.2] equal c and i resp
param.rh = [0.0000000;0.0000000;0];
